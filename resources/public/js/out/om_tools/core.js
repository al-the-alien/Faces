...
if(typeof om_tools.core.t26356 !== 'undefined'){
} else {

/**
* @constructor
*/
om_tools.core.t26356 = (function (get_state,owner,state_proxy,meta26357){
...
om_tools.core.t26356.prototype.cljs$core$ISwap$_swap_BANG_$arity$2 = ((function (get_state){
return (function (s,f){
var self__ = this;
var s__$1 = this;
...
om_tools.core.t26356.prototype.cljs$core$ISwap$_swap_BANG_$arity$3 = ((function (get_state){
...
om_tools.core.t26356.prototype.cljs$core$ISwap$_swap_BANG_$arity$4 = ((function (get_state){
...
om_tools.core.t26356.prototype.cljs$core$ISwap$_swap_BANG_$arity$5 = ((function (get_state){
...
om_tools.core.t26356.prototype.cljs$core$IReset$_reset_BANG_$arity$2 = ((function (get_state){
return (function (_,v){
var self__ = this;
var ___$1 = this;
...
om_tools.core.t26356.prototype.cljs$core$IDeref$_deref$arity$1 = ((function (get_state){
return (function (_){
var self__ = this;
var ___$1 = this;
...
om_tools.core.t26356.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (get_state){
...
om_tools.core.t26356.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (get_state){
return (function (_26358,meta26357__$1){
var self__ = this;
var _26358__$1 = this;
return (new om_tools.core.t26356(self__.get_state,self__.owner,self__.state_proxy,meta26357__$1));
});})(get_state))
;

om_tools.core.t26356.cljs$lang$type = true;

om_tools.core.t26356.cljs$lang$ctorStr = "om-tools.core/t26356";

om_tools.core.t26356.cljs$lang$ctorPrWriter = ((function (get_state){
return (function (this__15031__auto__,writer__15032__auto__,opt__15033__auto__){
return cljs.core._write.call(null,writer__15032__auto__,"om-tools.core/t26356");
});})(get_state))
;

om_tools.core.__GT_t26356 = ((function (get_state){
return (function __GT_t26356(get_state__$1,owner__$1,state_proxy__$1,meta26357){
return (new om_tools.core.t26356(get_state__$1,owner__$1,state_proxy__$1,meta26357));
});})(get_state))
;

}

return (new om_tools.core.t26356(get_state,owner,state_proxy,cljs.core.PersistentArrayMap.EMPTY));
} else {
return null;
}
});
