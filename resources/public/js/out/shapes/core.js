...
var G__171244__i = 0, G__171244__a = new Array(arguments.length -  0);
while (G__171244__i < G__171244__a.length) {G__171244__a[G__171244__i] = arguments[G__171244__i + 0]; ++G__171244__i;}
  xs = new cljs.core.IndexedSeq(G__171244__a,0);
} 
return avg__delegate.call(this,xs);};
avg.cljs$lang$maxFixedArity = 0;
avg.cljs$lang$applyTo = (function (arglist__171245){
var xs = cljs.core.seq(arglist__171245);
...
shapes.core.pupils = (function pupils(p__171246,dev_QMARK_){
var map__171248 = p__171246;
var map__171248__$1 = ((cljs.core.seq_QMARK_.call(null,map__171248))?cljs.core.apply.call(null,cljs.core.hash_map,map__171248):map__171248);
var measures = map__171248__$1;
var eye_ry = cljs.core.get.call(null,map__171248__$1,new cljs.core.Keyword(null,"eye-ry","eye-ry",933465119));
var eye_rx = cljs.core.get.call(null,map__171248__$1,new cljs.core.Keyword(null,"eye-rx","eye-rx",67315923));
var eye_cy = cljs.core.get.call(null,map__171248__$1,new cljs.core.Keyword(null,"eye-cy","eye-cy",650254757));
var eye_cxb = cljs.core.get.call(null,map__171248__$1,new cljs.core.Keyword(null,"eye-cxb","eye-cxb",1053942691));
var eye_cxa = cljs.core.get.call(null,map__171248__$1,new cljs.core.Keyword(null,"eye-cxa","eye-cxa",-1029825486));
...
shapes.core.eyes = (function eyes(p__171249,dev_QMARK_){
var map__171251 = p__171249;
var map__171251__$1 = ((cljs.core.seq_QMARK_.call(null,map__171251))?cljs.core.apply.call(null,cljs.core.hash_map,map__171251):map__171251);
var measures = map__171251__$1;
var head_ry = cljs.core.get.call(null,map__171251__$1,new cljs.core.Keyword(null,"head-ry","head-ry",-2093507644));
var head_rx = cljs.core.get.call(null,map__171251__$1,new cljs.core.Keyword(null,"head-rx","head-rx",-1157911938));
var head_height = cljs.core.get.call(null,map__171251__$1,new cljs.core.Keyword(null,"head-height","head-height",1646756657));
var head_width = cljs.core.get.call(null,map__171251__$1,new cljs.core.Keyword(null,"head-width","head-width",-652130664));
var head_cy = cljs.core.get.call(null,map__171251__$1,new cljs.core.Keyword(null,"head-cy","head-cy",-1378313232));
var head_cx = cljs.core.get.call(null,map__171251__$1,new cljs.core.Keyword(null,"head-cx","head-cx",-1674502265));
...
shapes.core.draw_eyes = (function draw_eyes(p__171252){
var map__171254 = p__171252;
var map__171254__$1 = ((cljs.core.seq_QMARK_.call(null,map__171254))?cljs.core.apply.call(null,cljs.core.hash_map,map__171254):map__171254);
var eye_ry = cljs.core.get.call(null,map__171254__$1,new cljs.core.Keyword(null,"eye-ry","eye-ry",933465119));
var highlight_cxb = cljs.core.get.call(null,map__171254__$1,new cljs.core.Keyword(null,"highlight-cxb","highlight-cxb",-700161662));
var eye_cxb = cljs.core.get.call(null,map__171254__$1,new cljs.core.Keyword(null,"eye-cxb","eye-cxb",1053942691));
var eye_cy = cljs.core.get.call(null,map__171254__$1,new cljs.core.Keyword(null,"eye-cy","eye-cy",650254757));
var pupil_r = cljs.core.get.call(null,map__171254__$1,new cljs.core.Keyword(null,"pupil-r","pupil-r",1531003590));
var pupil_cy = cljs.core.get.call(null,map__171254__$1,new cljs.core.Keyword(null,"pupil-cy","pupil-cy",1572369865));
var highlight_cxa = cljs.core.get.call(null,map__171254__$1,new cljs.core.Keyword(null,"highlight-cxa","highlight-cxa",-206081206));
var highlight_r = cljs.core.get.call(null,map__171254__$1,new cljs.core.Keyword(null,"highlight-r","highlight-r",-332764851));
var eye_cxa = cljs.core.get.call(null,map__171254__$1,new cljs.core.Keyword(null,"eye-cxa","eye-cxa",-1029825486));
var pupil_cxb = cljs.core.get.call(null,map__171254__$1,new cljs.core.Keyword(null,"pupil-cxb","pupil-cxb",1095720403));
var eye_rx = cljs.core.get.call(null,map__171254__$1,new cljs.core.Keyword(null,"eye-rx","eye-rx",67315923));
var pupil_cxa = cljs.core.get.call(null,map__171254__$1,new cljs.core.Keyword(null,"pupil-cxa","pupil-cxa",264217686));
var highlight_cy = cljs.core.get.call(null,map__171254__$1,new cljs.core.Keyword(null,"highlight-cy","highlight-cy",-186448681));
...
shapes.core.nose = (function nose(p__171255,dev_QMARK_){
var map__171257 = p__171255;
var map__171257__$1 = ((cljs.core.seq_QMARK_.call(null,map__171257))?cljs.core.apply.call(null,cljs.core.hash_map,map__171257):map__171257);
var measures = map__171257__$1;
var horizontal_b = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"horizontal-b","horizontal-b",602159673));
var vertical_b = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"vertical-b","vertical-b",-117595011));
var head_rx = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"head-rx","head-rx",-1157911938));
var mouth_y = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"mouth-y","mouth-y",1691079390));
var eye_ry = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"eye-ry","eye-ry",933465119));
var eye_cxb = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"eye-cxb","eye-cxb",1053942691));
var head_ry = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"head-ry","head-ry",-2093507644));
var eye_cy = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"eye-cy","eye-cy",650254757));
var pupil_r = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"pupil-r","pupil-r",1531003590));
var head_cx = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"head-cx","head-cx",-1674502265));
var pupil_cy = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"pupil-cy","pupil-cy",1572369865));
var vertical_a = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"vertical-a","vertical-a",464885929));
var horizontal_a = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"horizontal-a","horizontal-a",398345994));
var head_cy = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"head-cy","head-cy",-1378313232));
var head_height = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"head-height","head-height",1646756657));
var eye_cxa = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"eye-cxa","eye-cxa",-1029825486));
var eye_rx = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"eye-rx","eye-rx",67315923));
var head_width = cljs.core.get.call(null,map__171257__$1,new cljs.core.Keyword(null,"head-width","head-width",-652130664));
var nose_cx = head_cx;
...
shapes.core.draw_nose = (function draw_nose(p__171258){
var map__171260 = p__171258;
var map__171260__$1 = ((cljs.core.seq_QMARK_.call(null,map__171260))?cljs.core.apply.call(null,cljs.core.hash_map,map__171260):map__171260);
var nose_clip_yc = cljs.core.get.call(null,map__171260__$1,new cljs.core.Keyword(null,"nose-clip-yc","nose-clip-yc",-340569830));
var nose_clip_xa = cljs.core.get.call(null,map__171260__$1,new cljs.core.Keyword(null,"nose-clip-xa","nose-clip-xa",-1415311041));
var nose_cx = cljs.core.get.call(null,map__171260__$1,new cljs.core.Keyword(null,"nose-cx","nose-cx",-829610592));
var nose_rx = cljs.core.get.call(null,map__171260__$1,new cljs.core.Keyword(null,"nose-rx","nose-rx",-663834303));
var nose_shadow_clip_y = cljs.core.get.call(null,map__171260__$1,new cljs.core.Keyword(null,"nose-shadow-clip-y","nose-shadow-clip-y",-1293866494));
var nose_cy = cljs.core.get.call(null,map__171260__$1,new cljs.core.Keyword(null,"nose-cy","nose-cy",1639299138));
var nose_clip_width = cljs.core.get.call(null,map__171260__$1,new cljs.core.Keyword(null,"nose-clip-width","nose-clip-width",1579765635));
var nose_ry = cljs.core.get.call(null,map__171260__$1,new cljs.core.Keyword(null,"nose-ry","nose-ry",-556167034));
var nose_clip_yab = cljs.core.get.call(null,map__171260__$1,new cljs.core.Keyword(null,"nose-clip-yab","nose-clip-yab",1476607987));
var nose_clip_height = cljs.core.get.call(null,map__171260__$1,new cljs.core.Keyword(null,"nose-clip-height","nose-clip-height",-1703773324));
var nose_clip_xc = cljs.core.get.call(null,map__171260__$1,new cljs.core.Keyword(null,"nose-clip-xc","nose-clip-xc",-1863115051));
var nose_clip_xb = cljs.core.get.call(null,map__171260__$1,new cljs.core.Keyword(null,"nose-clip-xb","nose-clip-xb",434604823));
...
shapes.core.mouth = (function mouth(p__171261,dev_QMARK_){
var map__171263 = p__171261;
var map__171263__$1 = ((cljs.core.seq_QMARK_.call(null,map__171263))?cljs.core.apply.call(null,cljs.core.hash_map,map__171263):map__171263);
var measures = map__171263__$1;
var head_rx = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"head-rx","head-rx",-1157911938));
var eye_ry = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"eye-ry","eye-ry",933465119));
var nose_cy = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"nose-cy","nose-cy",1639299138));
var eye_cxb = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"eye-cxb","eye-cxb",1053942691));
var head_ry = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"head-ry","head-ry",-2093507644));
var eye_cy = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"eye-cy","eye-cy",650254757));
var head_cx = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"head-cx","head-cx",-1674502265));
var horizontal_c = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"horizontal-c","horizontal-c",-427119703));
var vertical_a = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"vertical-a","vertical-a",464885929));
var head_cy = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"head-cy","head-cy",-1378313232));
var a_to_b = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"a-to-b","a-to-b",504354032));
var head_height = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"head-height","head-height",1646756657));
var eye_cxa = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"eye-cxa","eye-cxa",-1029825486));
var head_width = cljs.core.get.call(null,map__171263__$1,new cljs.core.Keyword(null,"head-width","head-width",-652130664));
...
shapes.core.draw_mouth = (function draw_mouth(p__171264){
var map__171266 = p__171264;
var map__171266__$1 = ((cljs.core.seq_QMARK_.call(null,map__171266))?cljs.core.apply.call(null,cljs.core.hash_map,map__171266):map__171266);
var measures = map__171266__$1;
var mouth_rx = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"mouth-rx","mouth-rx",-1864884005));
var head_rx = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"head-rx","head-rx",-1157911938));
var mouth_cx = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"mouth-cx","mouth-cx",-1408973953));
var test_height = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"test-height","test-height",-1286786848));
var head_ry = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"head-ry","head-ry",-2093507644));
var mouth_cy = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"mouth-cy","mouth-cy",2005931686));
var head_cx = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"head-cx","head-cx",-1674502265));
var horizontal_c = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"horizontal-c","horizontal-c",-427119703));
var below_c = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"below-c","below-c",-1689698386));
var head_cy = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"head-cy","head-cy",-1378313232));
var mouth_clip_x = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"mouth-clip-x","mouth-clip-x",-1176852240));
var mouth_clip_height = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"mouth-clip-height","mouth-clip-height",1513269617));
var mouth_clip_y = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"mouth-clip-y","mouth-clip-y",-1725633516));
var mouth_ry = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"mouth-ry","mouth-ry",-1000769801));
var mouth_clip_width = cljs.core.get.call(null,map__171266__$1,new cljs.core.Keyword(null,"mouth-clip-width","mouth-clip-width",1861991800));
...
shapes.core.head = (function head(p__171267,dev_QMARK_){
var map__171269 = p__171267;
var map__171269__$1 = ((cljs.core.seq_QMARK_.call(null,map__171269))?cljs.core.apply.call(null,cljs.core.hash_map,map__171269):map__171269);
var height = cljs.core.get.call(null,map__171269__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var width = cljs.core.get.call(null,map__171269__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var cy = cljs.core.get.call(null,map__171269__$1,new cljs.core.Keyword(null,"cy","cy",755331060));
var cx = cljs.core.get.call(null,map__171269__$1,new cljs.core.Keyword(null,"cx","cx",1272694324));
...
var face__delegate = function (dev_QMARK_,p__171270){
var map__171272 = p__171270;
var map__171272__$1 = ((cljs.core.seq_QMARK_.call(null,map__171272))?cljs.core.apply.call(null,cljs.core.hash_map,map__171272):map__171272);
var proportional_QMARK_ = cljs.core.get.call(null,map__171272__$1,new cljs.core.Keyword(null,"proportional?","proportional?",644090690));
...
var G__171273__i = 0, G__171273__a = new Array(arguments.length -  1);
while (G__171273__i < G__171273__a.length) {G__171273__a[G__171273__i] = arguments[G__171273__i + 1]; ++G__171273__i;}
  p__171270 = new cljs.core.IndexedSeq(G__171273__a,0);
} 
return face__delegate.call(this,dev_QMARK_,p__171270);};
face.cljs$lang$maxFixedArity = 1;
face.cljs$lang$applyTo = (function (arglist__171274){
var dev_QMARK_ = cljs.core.first(arglist__171274);
var p__171270 = cljs.core.rest(arglist__171274);
return face__delegate(dev_QMARK_,p__171270);
});
face.cljs$core$IFn$_invoke$arity$variadic = face__delegate;
return face;
})()
;
shapes.core.draw_face = (function draw_face(p__171275){
var map__171277 = p__171275;
var map__171277__$1 = ((cljs.core.seq_QMARK_.call(null,map__171277))?cljs.core.apply.call(null,cljs.core.hash_map,map__171277):map__171277);
var measures = map__171277__$1;
var head_height = cljs.core.get.call(null,map__171277__$1,new cljs.core.Keyword(null,"head-height","head-height",1646756657));
var head_width = cljs.core.get.call(null,map__171277__$1,new cljs.core.Keyword(null,"head-width","head-width",-652130664));
var head_ry = cljs.core.get.call(null,map__171277__$1,new cljs.core.Keyword(null,"head-ry","head-ry",-2093507644));
var head_rx = cljs.core.get.call(null,map__171277__$1,new cljs.core.Keyword(null,"head-rx","head-rx",-1157911938));
var head_cy = cljs.core.get.call(null,map__171277__$1,new cljs.core.Keyword(null,"head-cy","head-cy",-1378313232));
var head_cx = cljs.core.get.call(null,map__171277__$1,new cljs.core.Keyword(null,"head-cx","head-cx",-1674502265));
