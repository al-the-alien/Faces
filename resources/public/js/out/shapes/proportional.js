...
while (G__41062__i < G__41062__a.length) {G__41062__a[G__41062__i] = arguments[G__41062__i + 0]; ++G__41062__i;}
  content = new cljs.core.IndexedSeq(G__41062__a,0);
} 
return println__delegate.call(this,content);};
println.cljs$lang$maxFixedArity = 0;
println.cljs$lang$applyTo = (function (arglist__41063){
var content = cljs.core.seq(arglist__41063);
...
shapes.proportional.pupils = (function pupils(p__41064,dev_QMARK_){
var map__41066 = p__41064;
var map__41066__$1 = ((cljs.core.seq_QMARK_.call(null,map__41066))?cljs.core.apply.call(null,cljs.core.hash_map,map__41066):map__41066);
var eye_ry = cljs.core.get.call(null,map__41066__$1,new cljs.core.Keyword(null,"eye-ry","eye-ry",933465119));
var eye_rx = cljs.core.get.call(null,map__41066__$1,new cljs.core.Keyword(null,"eye-rx","eye-rx",67315923));
var eye_cy = cljs.core.get.call(null,map__41066__$1,new cljs.core.Keyword(null,"eye-cy","eye-cy",650254757));
var eye_cxb = cljs.core.get.call(null,map__41066__$1,new cljs.core.Keyword(null,"eye-cxb","eye-cxb",1053942691));
var eye_cxa = cljs.core.get.call(null,map__41066__$1,new cljs.core.Keyword(null,"eye-cxa","eye-cxa",-1029825486));
...
shapes.proportional.eyes = (function eyes(p__41067,dev_QMARK_){
var map__41069 = p__41067;
var map__41069__$1 = ((cljs.core.seq_QMARK_.call(null,map__41069))?cljs.core.apply.call(null,cljs.core.hash_map,map__41069):map__41069);
var measures = map__41069__$1;
var head_rx = cljs.core.get.call(null,map__41069__$1,new cljs.core.Keyword(null,"head-rx","head-rx",-1157911938));
var head_height = cljs.core.get.call(null,map__41069__$1,new cljs.core.Keyword(null,"head-height","head-height",1646756657));
var head_width = cljs.core.get.call(null,map__41069__$1,new cljs.core.Keyword(null,"head-width","head-width",-652130664));
var head_cy = cljs.core.get.call(null,map__41069__$1,new cljs.core.Keyword(null,"head-cy","head-cy",-1378313232));
var head_cx = cljs.core.get.call(null,map__41069__$1,new cljs.core.Keyword(null,"head-cx","head-cx",-1674502265));
...
shapes.proportional.draw_eyes = (function draw_eyes(p__41070){
...
var eye_ry = cljs.core.get.call(null,map__41072__$1,new cljs.core.Keyword(null,"eye-ry","eye-ry",933465119));
var highlight_cxb = cljs.core.get.call(null,map__41072__$1,new cljs.core.Keyword(null,"highlight-cxb","highlight-cxb",-700161662));
var eye_cxb = cljs.core.get.call(null,map__41072__$1,new cljs.core.Keyword(null,"eye-cxb","eye-cxb",1053942691));
var eye_cy = cljs.core.get.call(null,map__41072__$1,new cljs.core.Keyword(null,"eye-cy","eye-cy",650254757));
var pupil_r = cljs.core.get.call(null,map__41072__$1,new cljs.core.Keyword(null,"pupil-r","pupil-r",1531003590));
var pupil_cy = cljs.core.get.call(null,map__41072__$1,new cljs.core.Keyword(null,"pupil-cy","pupil-cy",1572369865));
var highlight_cxa = cljs.core.get.call(null,map__41072__$1,new cljs.core.Keyword(null,"highlight-cxa","highlight-cxa",-206081206));
var highlight_r = cljs.core.get.call(null,map__41072__$1,new cljs.core.Keyword(null,"highlight-r","highlight-r",-332764851));
var eye_cxa = cljs.core.get.call(null,map__41072__$1,new cljs.core.Keyword(null,"eye-cxa","eye-cxa",-1029825486));
var pupil_cxb = cljs.core.get.call(null,map__41072__$1,new cljs.core.Keyword(null,"pupil-cxb","pupil-cxb",1095720403));
var eye_rx = cljs.core.get.call(null,map__41072__$1,new cljs.core.Keyword(null,"eye-rx","eye-rx",67315923));
var pupil_cxa = cljs.core.get.call(null,map__41072__$1,new cljs.core.Keyword(null,"pupil-cxa","pupil-cxa",264217686));
var highlight_cy = cljs.core.get.call(null,map__41072__$1,new cljs.core.Keyword(null,"highlight-cy","highlight-cy",-186448681));
...
shapes.proportional.nose = (function nose(p__41073,dev_QMARK_){
var map__41075 = p__41073;
var map__41075__$1 = ((cljs.core.seq_QMARK_.call(null,map__41075))?cljs.core.apply.call(null,cljs.core.hash_map,map__41075):map__41075);
var measures = map__41075__$1;
var eye_cy = cljs.core.get.call(null,map__41075__$1,new cljs.core.Keyword(null,"eye-cy","eye-cy",650254757));
var eye_cxb = cljs.core.get.call(null,map__41075__$1,new cljs.core.Keyword(null,"eye-cxb","eye-cxb",1053942691));
var eye_cxa = cljs.core.get.call(null,map__41075__$1,new cljs.core.Keyword(null,"eye-cxa","eye-cxa",-1029825486));
var head_cy = cljs.core.get.call(null,map__41075__$1,new cljs.core.Keyword(null,"head-cy","head-cy",-1378313232));
var head_cx = cljs.core.get.call(null,map__41075__$1,new cljs.core.Keyword(null,"head-cx","head-cx",-1674502265));
var nose_x = head_cx;
return cljs.core.merge.call(null,measures);
});
shapes.proportional.head = (function head(p__41076,dev_QMARK_){
var map__41078 = p__41076;
var map__41078__$1 = ((cljs.core.seq_QMARK_.call(null,map__41078))?cljs.core.apply.call(null,cljs.core.hash_map,map__41078):map__41078);
var height = cljs.core.get.call(null,map__41078__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var width = cljs.core.get.call(null,map__41078__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var cy = cljs.core.get.call(null,map__41078__$1,new cljs.core.Keyword(null,"cy","cy",755331060));
var cx = cljs.core.get.call(null,map__41078__$1,new cljs.core.Keyword(null,"cx","cx",1272694324));
