...
var count_36885 = (0);
while(true){
var m_36886 = cljs.core.async.impl.dispatch.tasks.pop();
if((m_36886 == null)){
} else {
m_36886.call(null);

if((count_36885 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE)){
var G__36887 = (count_36885 + (1));
count_36885 = G__36887;
continue;
} else {
}
}
