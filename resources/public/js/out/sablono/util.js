...
sablono.util.ToString = (function (){var obj33485 = {};
return obj33485;
})();
...
sablono.util.ToURI = (function (){var obj33487 = {};
return obj33487;
})();
...
while (G__33488__i < G__33488__a.length) {G__33488__a[G__33488__i] = arguments[G__33488__i + 0]; ++G__33488__i;}
  xs = new cljs.core.IndexedSeq(G__33488__a,0);
} 
return as_str__delegate.call(this,xs);};
as_str.cljs$lang$maxFixedArity = 0;
as_str.cljs$lang$applyTo = (function (arglist__33489){
var xs = cljs.core.seq(arglist__33489);
...
var vec__33491 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__33491,(0),null);
var words = cljs.core.nthnext.call(null,vec__33491,(1));
...
var G__33493 = clojure.set.rename_keys.call(null,m,kmap);
var G__33493__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__33493,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__33493);
return G__33493__$1;
} else {
return m;
}
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__33494_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__33494_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__33494_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__33494_SHARP_)){
...
while (G__33495__i < G__33495__a.length) {G__33495__a[G__33495__i] = arguments[G__33495__i + 0]; ++G__33495__i;}
  maps = new cljs.core.IndexedSeq(G__33495__a,0);
} 
return merge_with_class__delegate.call(this,maps);};
merge_with_class.cljs$lang$maxFixedArity = 0;
merge_with_class.cljs$lang$applyTo = (function (arglist__33496){
var maps = cljs.core.seq(arglist__33496);
...
var vec__33500 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__33500,(0),null);
var names = cljs.core.nth.call(null,vec__33500,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__33500,tag_name,names){
return (function (p1__33497_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__33497_SHARP_));
});})(matches,vec__33500,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__33500,tag_name,names){
return (function (p1__33498_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__33498_SHARP_));
});})(matches,vec__33500,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__33501){
var vec__33504 = p__33501;
var tag = cljs.core.nth.call(null,vec__33504,(0),null);
var content = cljs.core.nthnext.call(null,vec__33504,(1));
...
var vec__33505 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__33505,(0),null);
var id = cljs.core.nth.call(null,vec__33505,(1),null);
var class$ = cljs.core.nth.call(null,vec__33505,(2),null);
