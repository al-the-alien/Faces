...
var f = (function (){var pred__38568 = cljs.core._EQ_;
var expr__38569 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__38568.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__38569))){
return ((function (pred__38568,expr__38569){
return (function (p1__38561_SHARP_){
return console.warn(p1__38561_SHARP_);
});
;})(pred__38568,expr__38569))
} else {
if(cljs.core.truth_(pred__38568.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__38569))){
return ((function (pred__38568,expr__38569){
return (function (p1__38562_SHARP_){
return console.debug(p1__38562_SHARP_);
});
;})(pred__38568,expr__38569))
} else {
if(cljs.core.truth_(pred__38568.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__38569))){
return ((function (pred__38568,expr__38569){
return (function (p1__38563_SHARP_){
return console.error(p1__38563_SHARP_);
});
;})(pred__38568,expr__38569))
} else {
return ((function (pred__38568,expr__38569){
return (function (p1__38564_SHARP_){
return console.log(p1__38564_SHARP_);
});
;})(pred__38568,expr__38569))
}
}
