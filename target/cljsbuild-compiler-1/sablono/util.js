...
sablono.util.ToString = (function (){var obj26383 = {};
return obj26383;
})();
...
return (function (){var or__5890__auto__ = (sablono.util.to_str[(function (){var G__26387 = x__6534__auto__;
return goog.typeOf(G__26387);
})()]);
if(or__5890__auto__){
return or__5890__auto__;
} else {
var or__5890__auto____$1 = (sablono.util.to_str["_"]);
...
sablono.util.ToURI = (function (){var obj26389 = {};
return obj26389;
})();
...
var x__6534__auto__ = (((x == null))?null:x);
return (function (){var or__5890__auto__ = (sablono.util.to_uri[(function (){var G__26393 = x__6534__auto__;
return goog.typeOf(G__26393);
})()]);
if(or__5890__auto__){
return or__5890__auto__;
} else {
var or__5890__auto____$1 = (sablono.util.to_uri["_"]);
if(or__5890__auto____$1){
return or__5890__auto____$1;
} else {
...
while (G__26394__i < G__26394__a.length) {G__26394__a[G__26394__i] = arguments[G__26394__i + 0]; ++G__26394__i;}
  xs = new cljs.core.IndexedSeq(G__26394__a,0);
} 
return as_str__delegate.call(this,xs);};
as_str.cljs$lang$maxFixedArity = 0;
as_str.cljs$lang$applyTo = (function (arglist__26395){
var xs = cljs.core.seq(arglist__26395);
...
var vec__26397 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
var first_word = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26397,(0),null);
var words = cljs.core.nthnext(vec__26397,(1));
...
var G__26399 = clojure.set.rename_keys(m,kmap);
var G__26399__$1 = ((cljs.core.map_QMARK_(cljs.core.constant$keyword$93.cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__26399,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$93], null),camel_case_keys):G__26399);
return G__26399__$1;
} else {
return m;
}
...
return clojure.set.rename_keys(sablono.util.camel_case_keys(attrs),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$94,cljs.core.constant$keyword$96,cljs.core.constant$keyword$95,cljs.core.constant$keyword$97], null));
});
/**
...
var classes = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__26400_SHARP_){
if(cljs.core.list_QMARK_(p1__26400_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__26400_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_(p1__26400_SHARP_)){
return p1__26400_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__26400_SHARP_], null);

}
}
}),cljs.core.array_seq([cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$94,maps)], 0))));
var maps__$1 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,maps);
if(cljs.core.empty_QMARK_(classes)){
return maps__$1;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(maps__$1,cljs.core.constant$keyword$94,classes);
}
};
...
while (G__26401__i < G__26401__a.length) {G__26401__a[G__26401__i] = arguments[G__26401__i + 0]; ++G__26401__i;}
  maps = new cljs.core.IndexedSeq(G__26401__a,0);
} 
return merge_with_class__delegate.call(this,maps);};
merge_with_class.cljs$lang$maxFixedArity = 0;
merge_with_class.cljs$lang$applyTo = (function (arglist__26402){
var maps = cljs.core.seq(arglist__26402);
...
var vec__26406 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$57,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26406,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26406,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__26406,tag_name,names){
return (function (p1__26403_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__26403_SHARP_));
});})(matches,vec__26406,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.util.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__26406,tag_name,names){
return (function (p1__26404_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__26404_SHARP_));
});})(matches,vec__26406,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__26407){
var vec__26410 = p__26407;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26410,(0),null);
var content = cljs.core.nthnext(vec__26410,(1));
if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))){
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str(tag),cljs.core.str(" is not a valid element name.")].join(''),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$57,tag,cljs.core.constant$keyword$98,content], null));
} else {
}

var vec__26411 = sablono.util.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26411,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26411,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26411,(2),null);
var tag_attrs = sablono.util.compact_map(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$99,id,cljs.core.constant$keyword$94,class$], null));
...
return cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$100,null,cljs.core.constant$keyword$101,null,cljs.core.constant$keyword$102,null], null), null),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(type));
});
/**
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__5890__auto__ = x__$1.hasDomain();
